...
// SYCL implementations (compiler frontends) provide different means of distinguishing host and device code. Multi-pass compliers define __SYCL_DEVICE_ONLY__ in
