...
#define CELERITY_WORKAROUND_VERSION_MAJOR ACPP_VERSION_MAJOR
#define CELERITY_WORKAROUND_VERSION_MINOR ACPP_VERSION_MINOR
#define CELERITY_WORKAROUND_VERSION_PATCH ACPP_VERSION_PATCH
#else
