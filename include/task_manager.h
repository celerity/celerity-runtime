	  ...
	  public:
		...
		class delegate {
		  ...
		  public:
			...
			virtual void task_available(const task* tsk) = 0;
		};
		 ...
		 */
		size_t get_total_task_count() const { return m_total_task_count; }

		/**
		 * Returns the number of tasks currently being managed by the task_manager.
		 */
		size_t get_current_task_count() const { return m_task_graph.get_live_node_count(); }
