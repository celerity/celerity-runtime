...
class command_recorder {
  public:
	...
	const std::vector<std::unique_ptr<command_record>>& get_all() const { return m_recorded_commands; }
...
class instruction_recorder {
  public:
	...
	const std::vector<std::unique_ptr<instruction_record>>& get_all() const { return m_recorded_instructions; }
