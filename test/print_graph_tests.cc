...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "x2>];I21[color=green3,shape=ellipse,label=<I21<br/>gather <b>copy</b><br/>from M1.A1 ([0,0,0] - [1,1,1])<br/>to M1.A4 +4 bytes<br/>B0 {[0,0,0] - "
	    "[1,1,1]} x4 bytes>];I22[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I22 (await-push C3)<br/><b>gather receive</b> T2.B0.R1<br/>B0 "
	    "[0,0,0] - [1,1,1] x2<br/>into M1.A4>];I23[color=blue,shape=box,margin=0.2,style=rounded,label=<I23 (reduction C4)<br/>global <b>reduce</b> "
	    "B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A4 x2<br/>to M1.A1 x1>];I24[color=cyan3,shape=ellipse,label=<I24<br/><b>free</b> M1.A4 <br/>8 "
	    "bytes>];I25[color=cyan3,shape=ellipse,label=<I25<br/>buffer <b>alloc</b> M1.A5<br/>for B1 [2,0,0] - [4,1,1]<br/>8%4 "
	    "bytes>];I26[color=green3,shape=ellipse,label=<I26<br/>coherence <b>copy</b><br/>from M3.A2 ([3,0,0] - [4,1,1])<br/>to M1.A5 ([2,0,0] - "
	    "[4,1,1])<br/>B1 {[3,0,0] - [4,1,1]} x4 bytes>];I27[color=green3,shape=ellipse,label=<I27<br/>coherence <b>copy</b><br/>from M2.A2 ([2,0,0] - "
	    "[3,1,1])<br/>to M1.A5 ([2,0,0] - [4,1,1])<br/>B1 {[2,0,0] - [3,1,1]} x4 bytes>];I28[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I28 "
	    "(push C5)<br/><b>send</b> T2.B1<br/>to N0 MSG1<br/>B1 [2,0,0] - [3,1,1]<br/>via M1.A5 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I29[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I29 (push C5)<br/><b>send</b> T2.B1<br/>to N0 MSG2<br/>B1 [3,0,0] - "
	    "[4,1,1]<br/>via M1.A5 [1,0,0] - [2,1,1]<br/>[1,1,1]x4 bytes>];I30[color=cyan3,shape=ellipse,label=<I30<br/>buffer <b>alloc</b> M1.A6<br/>for B1 "
	    "[0,0,0] - [2,1,1]<br/>8%4 bytes>];I31[color=cyan3,shape=ellipse,label=<I31<br/>buffer <b>alloc</b> M2.A3<br/>for B1 [1,0,0] - [2,1,1]<br/>4%4 "
	    ...
	    "C6)<br/><b>await receive</b> T2.B1<br/>B1 {[1,0,0] - [2,1,1]}>];I35[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I35 (await-push "
	    "C6)<br/><b>await receive</b> T2.B1<br/>B1 {[0,0,0] - [1,1,1]}>];I36[color=green3,shape=ellipse,label=<I36<br/>coherence <b>copy</b><br/>from M1.A6 "
	    ...
	    "[3,1,1]</font>>];P1->I28[dir=none,style=dashed,color=\"#606060\"];P2[margin=0.2,shape=cds,color=\"#606060\",label=<<font "
