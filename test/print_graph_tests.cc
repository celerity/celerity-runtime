...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "[1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I22[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I22 (await-push C4)<br/><b>gather "
	    ...
	    "C3)<br/>global <b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A4 x2<br/>to M1.A1 "
