...
TEST_CASE("command-graph printing is unchanged", "[print_graph][command-graph]") {
	...
	const std::string expected =
	    ...
	    "[1,1,1]>];id_0_5[color=deeppink2,shape=ellipse,label=<C5 on N0<br/>(R1) <b>await push</b> T2.B0.R1 <br/>B0 {[0,0,0] - "
	    "[1,1,1]}>];id_0_6[color=blue,shape=ellipse,label=<C6 on N0<br/><b>reduction</b> R1<br/> B0 {[0,0,0] - "
	    ...
	    "[4,1,1]}>];id_0_0->id_0_1[color=orchid];id_0_0->id_0_5[color=orchid];id_0_0->id_0_11[color=orchid];id_0_1->id_0_2[];id_0_1->id_0_3[];id_0_1->id_0_4[];"
	    "id_0_1->id_0_6[];id_0_1->id_0_7[];id_0_2->id_0_6[color=limegreen];id_0_3->id_0_6[color=limegreen];id_0_4->id_0_6[color=limegreen];id_0_5->id_0_6[];id_"
	    "0_6->id_0_7[];id_0_7->id_0_8[];id_0_7->id_0_9[];id_0_7->id_0_10[];id_0_7->id_0_12[];id_0_7->id_0_13[];id_0_7->id_0_15[];id_0_8->id_0_14[color=orange];"
...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "[1,1,1]<br/>via M1.A1 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I19[color=cyan3,shape=ellipse,label=<I19<br/>gather <b>alloc</b> M1.A4<br/>for B0 "
	    "[0,0,0] - [1,1,1] x2<br/>8%4 bytes>];I20[color=blue,shape=ellipse,label=<I20<br/><b>fill identity</b> for R1<br/>M1.A4 "
	    "x2>];I21[color=green3,shape=ellipse,label=<I21<br/>gather <b>copy</b><br/>from M1.A1 ([0,0,0] - [1,1,1])<br/>to M1.A4 + 4 bytes ([0,0,0] - "
	    "[1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I22[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I22 (await-push C3)<br/><b>gather "
	    ...
	    "x1>];I24[color=cyan3,shape=ellipse,label=<I24<br/><b>free</b> M1.A4 <br/>8 bytes>];I25[color=green3,shape=ellipse,label=<I25<br/>coherence "
	    "<b>copy</b><br/>from M2.A2 ([2,0,0] - [3,1,1])<br/>to M1.A2 ([2,0,0] - [4,1,1])<br/>B1 {[2,0,0] - [3,1,1]} x4 "
	    "bytes>];I26[color=green3,shape=ellipse,label=<I26<br/>coherence <b>copy</b><br/>from M3.A2 ([3,0,0] - [4,1,1])<br/>to M1.A2 ([2,0,0] - "
	    "[4,1,1])<br/>B1 {[3,0,0] - [4,1,1]} x4 bytes>];I27[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I27 (push C5)<br/><b>send</b> "
	    "T2.B1<br/>to N0 MSG1<br/>B1 [2,0,0] - [3,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I28[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I28 (push C5)<br/><b>send</b> T2.B1<br/>to N0 MSG2<br/>B1 [3,0,0] - "
	    "[4,1,1]<br/>via M1.A2 [1,0,0] - [2,1,1]<br/>[1,1,1]x4 bytes>];I29[color=cyan3,shape=ellipse,label=<I29<br/>buffer <b>alloc</b> M1.A5<br/>for B1 "
	    "[0,0,0] - [2,1,1]<br/>8%4 bytes>];I30[color=cyan3,shape=ellipse,label=<I30<br/>buffer <b>alloc</b> M2.A3<br/>for B1 [1,0,0] - [2,1,1]<br/>4%4 "
	    "bytes>];I31[color=cyan3,shape=ellipse,label=<I31<br/>buffer <b>alloc</b> M3.A3<br/>for B1 [0,0,0] - [1,1,1]<br/>4%4 "
	    "bytes>];I32[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I32 (await-push C6)<br/><b>split receive</b> T2.B1<br/>B1 {[0,0,0] - "
	    ...
	    "C6)<br/><b>await receive</b> T2.B1<br/>B1 {[1,0,0] - [2,1,1]}>];I34[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I34 (await-push "
	    "C6)<br/><b>await receive</b> T2.B1<br/>B1 {[0,0,0] - [1,1,1]}>];I35[color=green3,shape=ellipse,label=<I35<br/>coherence <b>copy</b><br/>from M1.A5 "
	    ...
	    "(device-compute T2, execution C7)<br/><b>device kernel</b><br/>on D0 [2,0,0] - [3,1,1]<br/>+ access B0 [0,0,0] - [1,1,1]<br/>via M2.A1 [0,0,0] - "
	    "[1,1,1]<br/>+ access B1 [1,0,0] - [2,1,1]<br/>via M2.A3 [0,0,0] - [1,1,1]<br/>+ access B2 [0,0,0] - [0,0,0]<br/>via null [0,0,0] - "
	    "[0,0,0]>];I40[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I40 (device-compute T2, execution C7)<br/><b>device kernel</b><br/>on D1 "
	    ...
	    "bytes>];I44[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I44 (await-push C9)<br/><b>receive</b> T4.B2<br/>B2 {[0,0,0] - "
	    "[1,1,1]}<br/>into M1.A6 (B2 [0,0,0] - [1,1,1])<br/>x4 bytes>];I45[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I45 (CG2 "
	    "collective-host T4, execution C10)<br/><b>host task</b><br/>on host [1,0,0] - [2,1,1]<br/>+ access B0 [0,0,0] - [1,1,1]<br/>via M1.A1 [0,0,0] - "
	    ...
	    "];I0->I11[color=orchid];I0->I19[color=orchid];I0->I29[color=orchid];I0->I30[color=orchid];I0->I31[color=orchid];I0->I42[color=blue];I0->I43[color="
	    ...
	    "color=cyan3];I7->I9[];I8->I10[];I9->I12[];I9->I25[color=limegreen];I10->I13[];I10->I26[color=limegreen];I11->I14[color=cyan3];I11->I15[color=cyan3];"
	    "I12->I14[];I12->I25[];I13->I15[];I13->I26[];I14->I16[];I14->I37[color=limegreen];I15->I16[];I15->I38[color=limegreen];I16->I17[color=cyan3];I16->I18[]"
	    ";I16->I21[];I17->I41[color=orange];I18->I23[color=limegreen];I19->I20[color=cyan3];I20->I21[color=limegreen];I20->I22[color=limegreen];I21->I23[];I22-"
	    ">I23[];I23->I24[color=cyan3];I23->I37[];I23->I38[];I23->I45[];I23->I46[];I24->I41[color=orange];I25->I27[];I25->I53[color=cyan3];I26->I28[];I26->I55["
	    "color=cyan3];I27->I41[color=orange];I27->I51[color=cyan3];I28->I41[color=orange];I28->I51[color=cyan3];I29->I32[color=cyan3];I30->I35[color=cyan3];"
	    "I31->I36[color=cyan3];I32->I33[color=gray];I32->I34[color=gray];I33->I35[];I34->I36[];I35->I39[];I35->I52[color=cyan3];I36->I40[];I36->I52[color="
	    "cyan3];I37->I39[];I37->I57[color=cyan3];I38->I40[];I38->I57[color=cyan3];I39->I41[color=orange];I39->I54[color=cyan3];I39->I58[color=cyan3];I40->I41["
	    "color=orange];I40->I56[color=cyan3];I40->I59[color=cyan3];I41->I60[color=orange];I42->I45[color=blue];I43->I44[color=cyan3];I44->I45[];I45->I48[];I45-"
	    ">I50[color=cyan3];I45->I57[color=cyan3];I46->I47[];I46->I57[color=cyan3];I47->I60[color=orange];I48->I49[];I49->I60[color=orange];I50->I60[color="
	    "orange];I51->I60[color=orange];I52->I60[color=orange];I53->I60[color=orange];I54->I60[color=orange];I55->I60[color=orange];I56->I60[color=orange];I57-"
	    ">I60[color=orange];I58->I60[color=orange];I59->I60[color=orange];P0[margin=0.2,shape=cds,color=\"#606060\",label=<<font "
	    "color=\"#606060\"><b>pilot</b> to N0 MSG0<br/>T2.B0.R1<br/>for B0 [0,0,0] - "
	    ...
	    "[3,1,1]</font>>];P1->I27[dir=none,style=dashed,color=\"#606060\"];P2[margin=0.2,shape=cds,color=\"#606060\",label=<<font "
	    "color=\"#606060\"><b>pilot</b> to N0 MSG2<br/>T2.B1<br/>for B1 [3,0,0] - [4,1,1]</font>>];P2->I28[dir=none,style=dashed,color=\"#606060\"];}";
