...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "[3,0,0] - [4,1,1]<br/>+ access B1 {[3,0,0] - [4,1,1]}<br/>via M3.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 [0,0,0] - [1,1,1]<br/>via M3.A1 "
	    "[0,0,0] - [1,1,1]>];I14[color=green3,shape=ellipse,margin=0,label=<I14<br/>gather <b>copy</b><br/>from M2.A1 ([0,0,0] - [1,1,1])<br/>to M1.A3 +0 "
	    "bytes<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes<br/>4 bytes total>];I15[color=green3,shape=ellipse,margin=0,label=<I15<br/>gather <b>copy</b><br/>from "
	    "M3.A1 ([0,0,0] - [1,1,1])<br/>to M1.A3 +4 bytes<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes<br/>4 bytes "
	    "total>];I16[color=blue,shape=ellipse,label=<I16<br/>local <b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A3 x2<br/>to M1.A1 "
	    ...
	    "(push C2)<br/><b>send</b> T2.B0.R1<br/>to N0 MSG0<br/>B0 [0,0,0] - [1,1,1]<br/>via M1.A1 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes<br/>4 bytes "
	    "total>];I19[color=cyan3,shape=ellipse,label=<I19<br/>gather <b>alloc</b> M1.A4<br/>for B0 [0,0,0] - [1,1,1] x2<br/>8 % 4 "
	    "bytes>];I20[color=blue,shape=ellipse,label=<I20<br/><b>fill identity</b> for R1<br/>M1.A4 "
	    ...
	    "T2, execution C7)<br/><b>device kernel</b><br/>on D0 [2,0,0] - [3,1,1]<br/>+ access B0 {[0,0,0] - [1,1,1]}<br/>via M2.A1 [0,0,0] - [1,1,1]<br/>+ "
	    "access B1 {[1,0,0] - [2,1,1]}<br/>via M2.A3 [0,0,0] - [1,1,1]<br/>+ access B2 {}<br/>via null [0,0,0] - "
	    ...
	    "[1,1,1]<br/>+ access B2 {}<br/>via null [0,0,0] - [0,0,0]>];I42[color=black,shape=box,margin=0.2,style=rounded,label=<I42 (T3, "
