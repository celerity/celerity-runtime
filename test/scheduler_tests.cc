...
TEST_CASE("scheduler(lookahead::automatic) flushes allocating commands after two horizons", "[scheduler]") {
	test_utils::scheduler_test_context sctx(1 /* num nodes */, 0 /* my nid */, 1 /* num devices */);
...
TEST_CASE("scheduler(lookahead::none) does not attempt to elide allocations", "[scheduler]") {
	test_utils::scheduler_test_context sctx(1 /* num nodes */, 0 /* my nid */, 1 /* num devices */);
...
TEST_CASE("scheduler(lookahead::infinite) does not flush commands unless forced to", "[scheduler]") {
	test_utils::scheduler_test_context sctx(1 /* num nodes */, 0 /* my nid */, 1 /* num devices */);
...
TEST_CASE("scheduler(lookahead::automatic) delays flushing while reallocations are pending", "[scheduler]") {
	test_utils::scheduler_test_context sctx(1 /* num nodes */, 0 /* my nid */, 1 /* num devices */);
...
TEST_CASE("scheduler(lookahead::automatic) avoids reallocations in the wave_sim pattern", "[scheduler]") {
...
TEST_CASE("scheduler(lookahead::automatic) avoids reallocations in the RSim pattern", "[scheduler]") {
	constexpr size_t num_devices = 4;
	test_utils::scheduler_test_context sctx(1 /* num nodes */, 0 /* my nid */, num_devices);
