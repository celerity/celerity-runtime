...
#include "task.h"
#include "task_manager.h" // for initial_epoch_task (TODO remove somehow? extra init epoch action maybe?)
#include "tracy.h"
#include "types.h"
...
void generator_impl::compile_epoch_command(batch& command_batch, const epoch_command& ecmd) {
	...
	if (ecmd.get_task()->get_id() == task_manager::initial_epoch_task) {
