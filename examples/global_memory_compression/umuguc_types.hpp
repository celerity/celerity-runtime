...
// -- Compression types --
using compression_type = celerity::compressed<celerity::compression::quantization<Point, sycl::vec<uint8_t, 3>>>;
using compression_tile_type = celerity::compressed<celerity::compression::point_cloud<Point, CompressedPoint>>;
