...
// { 	queue.submit([&](celerity::handler& cgh) { 		celerity::accessor rw_up{up, cgh, celerity::access::one_to_one{}, celerity::read_write}; 		celerity::accessor
// r_u{u, cgh, celerity::access::neighborhood{{1, 1}, celerity::neighborhood_shape::along_axes}, celerity::read_only}; 		celerity::local_accessor<float, 2>
// lap{celerity::range<2>{LOCAL_RANGE_X + 2, LOCAL_RANGE_Y + 2}, cgh};
...
// void initialize(
//     celerity::queue& queue, celerity::buffer<float, 2, compression_type_a> up, celerity::buffer<float, 2, compression_type_a> u, float dt, sycl::float2
//     delta) {
